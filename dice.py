...
print (Style.NORMAL+Fore.MAGENTA+"      Dice Kontol/"+Style.NORMAL+Fore.GREEN+"\n=======================================\n")
...
def dice(ws,ls):
   ...
   try:
     ...
     while True:
       ...
       print ("")
       sys.exit()
r = c.get(url,headers=ua,data={"a": "Login","Key": "b40d6b6a81594bd8942a08b8ffa07d87","Username": obj["Account"]["Username"],"Password": obj["Account"]["Password"],"Totp": ""})
